            ...
            <Paper className={classes.paper}>
                <Grid spacing={2} container xs={12} item justify="center">
                    <Grid container xs={12} item justify="center">
                        <Typography variant='h4' display='inline' className={classes.headingText}>
                            Congratulations!!!
                        </Typography>
                    </Grid>
                    <Grid container xs={12} item justify="center">
                    ...
                    <Grid container xs={12} item justify="center" className={classes.socialMediaContainer}>
                        <Typography>
                            Share the results &nbsp;
                        </Typography>
                        <Share value={"Scored " + percentageSuccess.toString() + "percentage in teikametrics quiz"}/>
                    </Grid>
                </Grid>
            </Paper>
        </div>
